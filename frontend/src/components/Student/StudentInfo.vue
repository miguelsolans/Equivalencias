    ...
    <v-container>
        <v-form class="my-5">
            ...
            <v-row class="text-right">
                <v-col>
                    <v-switch color="#187653" v-model="course.doesntExist" class="ml-md-5 my-2" label="Curso Inexistente" :disabled="readOnly"/>
                </v-col>
                <v-col>
                    <v-switch color="#187653" v-model="readOnly" class="ml-md-5 my-5" label="Modo de Leitura"/>
                </v-col>
                <v-col class="my-2">
