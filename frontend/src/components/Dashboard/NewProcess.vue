            ...
            handleSubmit(e) {
                ...
                UserService.newProcess(this.student)
                    ...
                    .catch(err => {
                        ...
                        this.createAlert("Oops!...","Houve um erro ao criar o novo processo. Tente novamente mais tarde, verifique se o processo já existe ou se todos os dados estão preenchidos.");
                    });
            },
            universityChosen() {
